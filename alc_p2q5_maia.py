...
def alc_cholesky(A):
    """
    Realiza a decomposição de Cholesky de uma matriz positiva definida A.
    
    Parâmetros:
    A (np.array): Matriz positiva definida de entrada.
    
    Retorna:
    np.array: Matriz triangular superior R tal que R^T * R = A.
    
    Levanta:
    Exception: Se a matriz A não for positiva definida.
    """
...
# Salve este código em um arquivo chamado alc_p2q5_seunome.py
